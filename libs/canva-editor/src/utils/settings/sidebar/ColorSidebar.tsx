    ...
    <Sidebar ref={ref} {...props}>
      ...
      <div css={{ padding: '0 20px', display: 'grid', rowGap: 24 }}>
        ...
        <div css={{ borderTop: '1px solid rgba(217, 219, 228, 0.6)' }}>
          <div css={{ padding: '8px 0', fontWeight: 700 }}>{t('common.defaultColors', 'Default Colors')}</div>
          <p
            css={{ color: 'rgba(13,18,22,.7)', fontSize: 11, margin: '6px 0' }}
          >
            {t('common.solidColors', 'Solid colors')}
          </p>
          <div
            css={{
              display: 'grid',
          ...
          {useGradient && (
            <>
              ...
              >
                {t('common.gradientColors', 'Gradient colors')}
              </p>
              <div
                css={{
                  display: 'grid',
